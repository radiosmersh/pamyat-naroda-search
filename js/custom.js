...
$(document).ready(function() {
    ...
    jQuery.fn.get_data = function() {
        ...
        if (jbd) {
            ...
            url = customAPI || 'http://python-flask-test-1153.appspot.com/pamyat/magazine/_search';
            tableID = "#jbd_table";
        }
        else {
            // url = customAPI || 'https://cdn.pamyatnaroda.mil.ru/ind/pamyat/document,map/_search';
            url = customAPI || 'http://python-flask-test-1153.appspot.com/pamyat/document,map/_search';
            tableID = "#dou_table";
        }
